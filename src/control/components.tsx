...
// Free-typing numeric field for coordinates. Keeps a local text buffer so the
// user can type partial values ("-", "37.") without the parsed prop fighting
// them; commits only finite numbers, and re-syncs when the prop changes
// (e.g. "Use my location").
